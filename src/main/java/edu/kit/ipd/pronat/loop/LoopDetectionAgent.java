package edu.kit.ipd.pronat.loop;

import java.util.List;
import java.util.Properties;

import edu.kit.ipd.pronat.loop.filter.KeyphraseFilter;
import org.kohsuke.MetaInfServices;

import edu.kit.ipd.pronat.loop.data.Keyphrase;
import edu.kit.ipd.pronat.loop.data.KeyphraseType;
import edu.kit.ipd.pronat.loop.data.Loop;
import edu.kit.ipd.pronat.loop.data.Utterance;
import edu.kit.ipd.pronat.loop.filter.CorefExtender;
import edu.kit.ipd.pronat.loop.filter.GrammarFilter;
